...
parser.add_argument('--train_data_paths', type=str, default='/data/wjk/GTA/')
parser.add_argument('--valid_data_paths', type=str, default='/data/wjk/GTA/')
parser.add_argument('--save_dir', type=str, default='./checkpoints/1024_test')
parser.add_argument('--gen_frm_dir', type=str, default='./results/1024_test')
