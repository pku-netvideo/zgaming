...
class MASA(nn.Module):
    ...
    def forward(self, lr, ref, ref_down, gt=None):
        ...
        torch.cuda.synchronize()
        end_time = time.time()
        print('get feature time: {}'.format(end_time - begin_time))
        ...
        torch.cuda.synchronize()
        end_time = time.time()
        print('search time: {}'.format(end_time - begin_time))
        ...
        torch.cuda.synchronize()
        end_time = time.time()
        print('search_org time: {}'.format(end_time - begin_time))
        torch.cuda.synchronize()
        begin_time = time.time()
        ...
        torch.cuda.synchronize()
        end_time = time.time()
        print('transfer time: {}'.format(end_time - begin_time))
        torch.cuda.synchronize()
        begin_time = time.time()
        out = self.decoder(fea_lr_l, warp_ref_l)
        torch.cuda.synchronize()
        end_time = time.time()
        print('decoder time: {}'.format(end_time - begin_time))
